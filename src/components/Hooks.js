...
const Hooks = () => {
  ...
  return (
    <div>
      ...
      <p>
        Name: {hooksState.persons[0].name}, birthday:{" "}
        {hooksState.persons[0].date}
      </p>
      <p>
        Name: {hooksState.persons[1].name}, birthday:{" "}
        {hooksState.persons[1].date}
      </p>
      {/* Using functional component removes need of using 'this,' to call functions */}
      <button type="submit" onClick={swapNameHandler}>
        Swap names
      </button>
